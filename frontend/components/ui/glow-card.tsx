...
export function GlowCard({
  ...
  const inlineStyles: CSSProperties = {
    ...
    ["--radius" as string]: "24",
    ["--border" as string]: "2",
    ["--backdrop" as string]: "hsl(0 0% 8% / 0.65)",
    ...
    backgroundImage: `radial-gradient(
      ...
      calc(var(--x, 0) * 1px)
      calc(var(--y, 0) * 1px),
      hsl(var(--hue, 210) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / 0.12),
      transparent
    )`,
  ...
  return (
    <>
      ...
      <div
        ...
        style={inlineStyles}
        className={cn(
          "relative grid gap-4 rounded-3xl p-1 shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-[6px]",
